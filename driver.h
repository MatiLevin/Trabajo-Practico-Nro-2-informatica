...
int16_t leer_temperatura_x100(void);   // Lee la temperatura medida por el sensor "LM35" conectado al ADC.
                                        // Convención: retorna la temperatura en centésimas de grado Celsius (°C × 100).
                                        // Ejemplo: 2345 representa 23.45 °C.
                                        // la función convirte la lectura del ADC
                                        // a temperatura aplicando la escala y calibración correspondiente.

int16_t leer_humedad_x100(void);       // Lee la humedad relativa desde el sensor ,tambien utilizando el lm35 .
                                        // Convención: retorna humedad en centésimas de porcentaje (% × 100).
                                        // Ejemplo: 6780 representa 67.80 %.
                                        // la función convirte la lectura del ADC
                                        // a un valor de humedad porcentual representado en una escala de 0 a 100
                                        // aplicando la escala y calibración correspondiente.

int16_t leer_calidad_aire_x100(void);  // Lee un valor representativo de la calidad del aire (CO2, VOCs, etc.)
                                        // Convención: retorna un valor de calidad de aire en centésimas de porcentaje (% × 100).
                                        // Ejemplo: 9210 representa 92.10 % (92.10% de "aire limpio" o índice inverso según sensor).
                                        // la función convirte la lectura del ADC
